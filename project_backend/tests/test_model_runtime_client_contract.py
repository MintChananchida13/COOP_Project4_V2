...
class ModelRuntimeClientContractTest(unittest.TestCase):
    ...
    def test_table_runtime_cell_bbox_geometry_is_preserved_for_backend_processing(self) -> None:
        payload = {
            "success": True,
            "model": "SLANeXt_wired",
            "result": {
                "raw_output": [
                    {
                        "html": "<table><tr><td>A</td><td>B</td></tr><tr><td>1</td><td>2</td></tr></table>",
                        "cell_bbox": [
                            {"row": 0, "col": 0, "text": "A", "bbox": {"x": 0, "y": 0, "width": 80, "height": 24}},
                            {"row": 0, "col": 1, "text": "B", "bbox": {"x": 80, "y": 0, "width": 80, "height": 24}},
                            {"row": 1, "col": 0, "text": "1", "bbox": {"x": 0, "y": 24, "width": 80, "height": 24}},
                            {"row": 1, "col": 1, "text": "2", "bbox": {"x": 80, "y": 24, "width": 80, "height": 24}},
                        ],
                        "structure_model": "SLANeXt_wired",
                        "score": 0.96,
                    }
        ...
        load_local.assert_not_called()
        self.assertEqual(result["table_rows"], [["A", "B"], ["1", "2"]])
        first_cell = result["table_structured"]["cells"][0]
        self.assertEqual(first_cell["bbox"], {"x": 0, "y": 0, "width": 80, "height": 24})
        self.assertEqual(result["raw_results"][0]["cell_bbox"][0]["bbox"]["width"], 80)

    def test_table_runtime_top_level_geometry_next_to_raw_output_is_not_dropped(self) -> None:
        payload = {
            "success": True,
            "model": "SLANeXt_wired",
            "result": {
                "raw_output": [{"html": "<table><tr><td>A</td><td>B</td></tr></table>"}],
                "cell_bbox": [
                    {"row": 0, "col": 0, "text": "A", "bbox": {"x": 0, "y": 0, "width": 80, "height": 24}},
                    {"row": 0, "col": 1, "text": "B", "bbox": {"x": 80, "y": 0, "width": 80, "height": 24}},
                ],
                "geometry_sources": ["raw_output[0].cell_bbox"],
            },
        }
        ...
        self.assertEqual(result["table_structured"]["cells"][1]["bbox"]["x"], 80)
        self.assertEqual(result["raw_results"][0]["geometry_sources"], ["raw_output[0].cell_bbox"])
    ...
    def test_table_remote_structure_without_cell_bbox_uses_grid_inference_for_backend_ocr_core(self) -> None:
        payload = {
            "success": True,
            "model": "SLANeXt_wired",
            "result": {
                "raw_output": [
                    {
                        "table_structured": {
                            "rows": [["Name", "Amount"], ["Apple", "10"]],
                            "cells": [
                                {"row": 0, "col": 0, "text": "Name"},
                                {"row": 0, "col": 1, "text": "Amount"},
                                {"row": 1, "col": 0, "text": "Apple"},
                                {"row": 1, "col": 1, "text": "10"},
                            ],
                            "headerRowCount": 1,
                        },
        ...
        with patch.dict("os.environ", {"TABLE_MODEL_URL": "https://table.example"}, clear=False), patch(
            ...
            return_value=(
                [
                    {"text": "col-a", "confidence": 0.94},
                    {"text": "col-b", "confidence": 0.93},
                    {"text": "thai-a", "confidence": 0.92},
                    {"text": "thai-b", "confidence": 0.91},
                ],
                {"ocr_core": "recognize_text_roi", "crop_count": 4},
            ),
        ) as ocr_core:
            result = recognize_table_v2(image)

        ocr_core.assert_called()
        self.assertEqual(result["table_rows"], [["col-a", "col-b"], ["thai-a", "thai-b"]])
        self.assertEqual(result["table_structured"]["cells"][0]["assignmentSource"], "backend_ocr_core")
        self.assertEqual(result["table_structured"]["cells"][0]["bboxSource"], "backend_grid_inference")
        self.assertEqual(result["table_debug"]["backend_ocr_core"]["bbox_inference"]["inferred_bbox_count"], 4)
